...
class PersonRelationshipTypeController extends Controller
{
    public function init()
    {
        $this->modelClass = PersonRelationshipType::class;
    ...
    public function actionIndex($org_id = null, $code = null)
    {
        ...
        $searchModel = PersonRelationshipType::searchModel([
    ...
    public function actionView($id)
    {
        ...
        return PersonRelationshipType::loadModel($id);
    }
